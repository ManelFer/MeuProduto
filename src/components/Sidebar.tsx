    ...
    <>
      ...
      >
        <div className="flex flex-col h-full">
          ...
          {/* User section */}
          <div className="px-3 py-4 border-t border-soft-border space-y-2">
            {/* User Info */}
            <Link
            ...
            >
              <div className="w-9 h-9 rounded-full bg-gradient-to-br from-pastel-lavender to-pastel-blue flex items-center justify-center text-sm font-bold text-gray-900 ring-2 ring-white">
            ...
            <button
              ...
              className="w-full flex items-center space-x-3 px-4 py-3 rounded-xl text-gray-700 hover:bg-pastel-pink/50 hover:text-gray-900 transition-all duration-200 font-medium text-sm"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
